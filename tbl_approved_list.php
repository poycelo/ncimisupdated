...
<div class="container-fluid px-3 py-0">
	<div class="col-lg-12 bg-white border p-3">
      <div class="form-row">
      	<div class="col-lg-12">
	         <!-- Page Heading -->
	         <h4 class="mb-2 text-gray-800">List of Approved Profiles</h4>
			 <hr 999/>
       	</div>
 		</div>
						...
						<tbody>
							<?php while($rowresult = mysqli_fetch_assoc($resultprofca)){ 
								...
								<tr>
									...
									<a href="vw_approved.php?SID=<?php echo $rowresult['SID'];?>" class="btn btn-outline-success text-xs form-control form-control-sm border">
