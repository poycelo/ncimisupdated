               ...
               Back
                ...
                <div class="form-row">
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-lg-12">
                            <table id="example" class="table table-bordered table-striped custom-font" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    while ($rowDA = mysqli_fetch_assoc($queryDA)) {
                                        ...
                                        <tr class="fieldGroupDA">
                                            ...
                                            <td><input type="text" class="form-control form-control-sm col-lg-12 text-xs" name="txtYear[]" value="<?php echo $rowDA['INFO_YEAR']; ?>" placeholder="Year" onkeyup="this.value = this.value.toUpperCase();"></td>
                                            ...
                                            <td class="text-center">
                                                <?php if ($certCount == 1) { ?>
                                                    <button type="button" id="addMore" name="somethingbtn" class="btn btn-success btn-sm addMoreDA"><i class="fas fa-plus fa-white"></i></button>
                                                <?php } else { ?>
                                    ...
                                    <tr class="fieldGroupCopyDA" style="display: none;">
                                        ...
                                        <td><input type="text" class="form-control form-control-sm col-lg-12 text-xs" name="txtYear[]" placeholder="Year" onkeyup="this.value = this.value.toUpperCase();">
                                        </td>
