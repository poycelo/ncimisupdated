          ...
          <div class="col-lg-12">
            <div class="demo-html">
             ...
             <!-- <div class="collapse" id="collapseExample">
              ...
              <table id="example" class="table-bordered display text-xs mt-3" style="width:100%;">
                ...
                <?php 
                  while($rowresult = mysqli_fetch_assoc($resultprofca)){ 
                    ...
                    <input type="hidden" name="ID" value="<?php echo $ID=$rowresult['SID']; ?>">
										<a data-toggle="modal" data-id="<?php echo $ID; ?>"  class="open-AddBookDialog" href="#upload"><button type="button" class="btn btn-primary form-control form-control-sm btn-sm mt-1">Upload</button></a>
									    </a>
                    <?php }?>
        ...
        <div class="modal-footer">
                <div class="form-group">
                   <?php $check = $rowresult['ATTACHED_FILENAME']; if($check<>'N/A'){ ?><a data-toggle="modal" data-target="#projDocOpen" href="#projDocOpen">
                       <button type="submit" class="btn btn-success" data-dismiss="modal"><span class="fas fa-folder-open mr-2"></span>View Uploaded Document</button></a>
                       <?php } ?>         
