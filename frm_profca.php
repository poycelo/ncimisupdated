...
<body>
    ...
    <?php
        ...
        $briefdesc          = $_POST['txtBriefdesc'];
            ...
            $dbConn->query('INSERT INTO tbl_vmgob 
                                                (SID, 
                                                INFO_VISION, 
                                                INFO_MISSION, 
                                                INFO_GOAL, 
...
<form method="post" name="myForm">
                        ...
                        <div class="col-lg-10 p-2">
                            <div class="form-row">
                                ...
                                <div class="row col-sm-2">
                                    ...
                                    Please specify:
                                <div class="col-sm-10 form-group form-line cost-box">
                                ...
                                <div class="row col-sm-2">
                                    ...
                                    LIVESTOCK
                                <div class="form-group col-sm-10 form-line cost-box">
                                ...
                                <div class="row col-sm-2">
                                    ...
                                    POULTRY
                                <div class="form-group form-line cost-box col-sm-10">
    ...
    <button type="submit" name="submit" class="btn btn-sm btn-success mt-2 ml-3">
