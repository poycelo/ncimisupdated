...
<div class="container-fluid px-3 py-0 custom-font">
   <div class="col-lg-12 bg-white border p-3">
      <div class="form-row">
         <div class="col-lg-10">
            <!-- Page Heading -->
            <h1 class="h5 mb-2 text-gray-800">Convergence Area Profile 
            <button class="btn-outline-danger border-0" disabled>[FLAGGED]<?php 
              if($row['INFO_STAT_REMARKS']!=NULL){
               echo 'Remarks: '.$row['INFO_STAT_REMARKS'];}
               else{ echo "";} ?></button> </h1>
         </div>
         <div class="col-lg-12 text-right">
            <a class="btn btn-sm btn-secondary" href="tbl_flagged.php">
      ...
      <div style="font-size: 0.8rem;">
         ...
         <div class="form-row border border-top-0">
            ...
            <div class="col-lg-2 p-2">
               <?php  echo $rowLocation['region_name']; ?>
            </div>
            <div class="col-lg-2 bg-label p-2">
               Province
            </div>
