...
$SID   = $_REQUEST['SID'];
$query = $dbConn->query("SELECT * FROM tbl_profilingca WHERE SID = '$SID' AND INFO_STAT_AF ='Approved'");
$row   = mysqli_fetch_assoc($query);


$queryrow = $dbConn->query("SELECT * FROM tbl_profilingca WHERE SID = '$SID' ");
$rowrow   = mysqli_fetch_assoc($queryrow);
   ...
   <div class="col-lg-12 bg-white border p-3">
      <div class="form-row">
         ...
         <div class="col-lg-12 text-right">
            <a class="btn btn-sm btn-secondary" href="tbl_approved.php">
               <i class="fas fa-arrow-left fa-xs mr-2"></i>
               Back
            </a>  
              <?php if($rowUserInfo["INFO_ACCESSLEVEL"] == 'ENCODER'  ){ ?>
               <!-- <a class="btn btn-sm btn-success" href="frm_edit_all.php?SID=<?php echo $rowrow['SID']; ?>">
