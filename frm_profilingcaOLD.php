                        ...
                        <div style="font-size: 0.9rem;font-family:Calibri;">
                            ...
                            <div class="form-row border border-top-0">
                                ...
                                <div class="col-lg-10 p-2">
                                    <input type="text" class="form-control text-xs" name="txtName" placeholder="Convergence Name" onkeyup="this.value = this.value.toUpperCase();" required>
                                </div>
                            </div>
                                        ...
                                        <div class="form-row p-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group cost-box">
                                                        <div class="form-line">
                                                            <input type="text" name="txtOthers" class="form-control" placeholder="Please Specify:" onkeyup="this.value = this.value.toUpperCase();" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
